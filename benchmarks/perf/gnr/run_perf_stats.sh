...
# kernel at Classes B and D. This is a separate, one-shot profiling pass --
# it does not do any core-count scaling; see scripts/nas/run_nas_scaling.sh
# and the per-app run_*_n-core.sh scripts for that.
#
# See run_perf_stats_mt.sh for the multithreading (SMT-enabled) counterpart.
#
...
RESULTS_DIR=$HOME/gnr-results/perf
