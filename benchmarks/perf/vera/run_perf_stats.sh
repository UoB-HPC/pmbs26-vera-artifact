...
# kernel at Class B and Class D. This is a separate, one-shot profiling
# pass -- it does not do any core-count scaling; see
# scripts/nas/run_nas_scaling.sh and the per-app run_*_n-core.sh scripts
# for that.
#
# See run_perf_stats_mt.sh for the same collection with SMT enabled
# (2 threads per physical core, all logical CPUs in use).
#
...
RESULTS_DIR=$HOME/joseph/results/perf
