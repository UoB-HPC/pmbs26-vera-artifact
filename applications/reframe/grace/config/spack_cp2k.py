...
class Cp2kSpackCheck(rfm.RegressionTest):
    ...
    def prepare_test(self):
        ...
        self.prerun_cmds = [
            f'curl -LJO https://raw.githubusercontent.com/cp2k/cp2k/refs/heads/master/benchmarks/{self.__bench}.inp'
        ]
        self.executable_opts += ['-i', '*.inp']
