...
class SpackBootstrap(rfm.RunOnlyRegressionTest):
    ...
    def set_bootstrap_vars(self):
        user_cache_path = f'/projects/brics/tgreen.brics/vera/.reframe/opt/spack-cache-1.1'
...
class SpackCompileOnlyBase(rfm.CompileOnlyRegressionTest):
    ...
    def setup_build_system(self):
        ...
        self.build_system.install_tree = '/projects/brics/tgreen.brics/vera/.reframe/opt/spack-1.1'
        ...
        install_opts = []
        if self.spacktest:
            install_opts.append('--test=root')
        self.build_system.install_opts = install_opts
